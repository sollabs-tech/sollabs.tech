...
const markSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 32 32">${markInner}</svg>`;

const avatarSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
  <rect width="512" height="512" fill="${BG}"/>
  <g transform="translate(96 96) scale(10)">${markInner}</g>
</svg>`;
...
const touchSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="180" height="180" viewBox="0 0 180 180">
  ...
  <g transform="translate(26 26) scale(4)">${markInner}</g>
</svg>`;
